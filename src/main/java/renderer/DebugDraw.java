...
public class DebugDraw {
    ...
    public static void addBox2D(Vector2f center, Vector2f dimensions, float rotation, Vector3f color, int lifetime) {
        Vector2f min = new Vector2f(center).sub(new Vector2f(dimensions).mul(0.5f)); // get the bottom left point
        Vector2f max = new Vector2f(center).add(new Vector2f(dimensions).mul(0.5f)); // get the top right point
