...
public class JMath {
    /**
     * Rotate a source vector2f to with a given angle in degree
     *
     *
     *
     *
     * @param vec stores the rotating result
     * @param angleDeg the rotating angle in degree
     * @param origin the origin point to rotate
     */
